...
$lang['Show thumbnails caption'] = 'Afficher la légende de la miniature';
...
$lang['Title Display Mode (Photo)'] = 'Mode d\'affichage des titres (photo)';
$lang['%d file'] = '%d fichier';
$lang['%d files'] = '%d fichiers';
$lang['Cache the big thumbnails (recommended)'] = 'Mettre les grandes miniatures en cache (recommandé)';
$lang['Changelog'] = 'Journal des mofidications';
$lang['Crop (Default)'] = 'Recadrer (par défaut)';
$lang['Delete images in GDThumb cache.'] = 'Supprimer les images du cache de GDThumb';
$lang['Do not Normalize (Default)'] = 'Ne pas normaliser (par défaut)';
$lang['Double the size of the first thumbnail'] = 'Doubler la taille de la première miniature';
$lang['Finds images that have not been cached and creates the cached version.'] = 'Trouver les images absentes du cache et créer leur version en cache';
$lang['Follow'] = 'Suivre';
